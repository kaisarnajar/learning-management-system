      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Manage physical books available for purchase. Add, edit, or update availability.
          </p>
        </div>
        <Link
      ...
      <div className="mt-8">
        {books.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-surface py-20 text-center">
            <p className="font-serif text-base font-semibold text-foreground">No books yet</p>
              ...
              <tbody className="divide-y divide-border">
                {books.map((book) => (
                  <tr key={book.id}>
                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium ${book.published ? "bg-emerald-100 text-emerald-800" : "bg-gray-100 text-gray-600"}`}>
