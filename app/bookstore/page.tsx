        ...
        {totalCount === 0 ? (
          ...
          <>
            <div className="mb-6 flex items-center justify-between">
              ...
              <Link
                href="/profile/cart"
                className="inline-flex items-center justify-center gap-2 min-h-11 rounded-full bg-primary px-4 py-3 text-sm font-semibold text-white hover:bg-primary-light transition-colors"
              >
