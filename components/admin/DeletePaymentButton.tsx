...
export function DeletePaymentButton({ submissionId }: { submissionId: string }) {
  ...
  return (
    <ConfirmationModal
      ...
      trigger={
        <button type="button" className="inline-flex items-center justify-center rounded-md border border-error bg-transparent px-2 py-1 text-xs font-semibold text-error hover:bg-error/10 disabled:opacity-60 ml-2">
          <svg
