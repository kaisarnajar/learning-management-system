...
export function AuthNav({ mobile = false, onLinkClick }: { mobile?: boolean; onLinkClick?: () => void }) {
  ...
  const linkClass = mobile
    ...
    : "whitespace-nowrap rounded-md px-1.5 py-2 text-ui-xs font-semibold text-foreground transition-colors hover:bg-accent-muted/50 hover:text-primary 2xl:px-2.5 2xl:text-sm";
      ...
      <Link
        ...
        className={
          mobile
            ...
            : "whitespace-nowrap rounded-full bg-primary px-2 py-2 text-ui-xs font-semibold text-white transition-colors hover:bg-primary-light 2xl:px-3 2xl:text-sm"
        }
        onClick={onLinkClick}
      >
        Register
