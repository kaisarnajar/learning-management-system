...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#003527] via-teal-900 to-[#002117] text-white">
      ...
      <div className="absolute inset-0 bg-brand-primary-dark/40 mix-blend-multiply pointer-events-none" />
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-12 px-4 py-16 sm:px-6 lg:py-24 md:flex-row md:items-center md:justify-between md:gap-16">
        ...
        <div className="min-w-0 max-w-2xl shrink-0">
          ...
          <div className="mt-10">
            <Link 
              href="/courses" 
              className="inline-flex items-center justify-center rounded bg-brand-gold-alt px-8 py-3.5 text-sm font-semibold text-brand-gold-dark-text transition-colors hover:bg-brand-gold-light"
            >
              Explore Courses
        ...
        <div className="relative w-full max-w-md shrink-0 motion-safe:animate-float">
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-[#95d3ba]/20 backdrop-blur-md">
            ...
            <div className="mb-6 h-[2px] w-12 bg-brand-gold-alt"></div>
            ...
            <div className="flex items-center gap-2">
              <svg className="h-5 w-5 text-brand-gold-alt" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="text-sm font-medium text-brand-gold-alt">Connecting Hearts with the Quran</span>
            </div>
          </div>
        </div>
