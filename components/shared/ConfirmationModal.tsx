...
export function ConfirmationModal({
  ...
  return (
    <>
      ...
      >
        <h3 className="text-lg font-semibold text-foreground leading-snug break-words">{title}</h3>
        <p className="mt-2 text-sm text-muted break-words leading-relaxed">{description}</p>
