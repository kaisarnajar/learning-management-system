    ...
    <ToastContext.Provider value={{ addToast, removeToast }}>
      ...
      <div className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center gap-3">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`flex items-center gap-4 w-96 max-w-[calc(100vw-2rem)] p-5 bg-surface rounded-xl shadow-xl border border-border animate-in slide-in-from-bottom-5 fade-in-90 ${
          ...
          >
            ...
            <p className="text-base font-medium text-foreground">{toast.message}</p>
            <button
