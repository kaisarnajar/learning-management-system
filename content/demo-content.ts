...
export const demoDailyInspirations: DemoDailyInspiration[] = [
  {
    ...
    englishTranslation: "Seek forgiveness from your Lord, then turn towards Him in repentance. Surely, my Lord is very merciful, most loving.",
  ...
  {
    id: "seed-demo-inspiration-5",
    kind: "QURAN",
    arabicText: "فَإِنَّ مَعَ الْعُسْرِ يُسْرًا ﴿٥﴾ إِنَّ مَعَ الْعُسْرِ يُسْرًا",
    englishTranslation: "For indeed, with hardship will come ease. Indeed, with hardship will come ease.",
    reference: "Surah Ash-Sharh 94:5-6",
    published: true,
  },
  {
    id: "seed-demo-inspiration-6",
    kind: "HADITH",
  ...
  {
    id: "seed-demo-inspiration-7",
    kind: "QURAN",
    arabicText: "وَلَا تَهِنُوا وَلَا تَحْزَنُوا وَأَنتُمُ الْأَعْلَوْنَ إِن كُنتُم مُّؤْمِنِينَ",
    englishTranslation: "Do not weaken and do not grieve, and you will be superior if you are [true] believers.",
    reference: "Surah Ali 'Imran 3:139",
    published: true,
  },
  {
    id: "seed-demo-inspiration-8",
    kind: "HADITH",
    arabicText: "مَنْ سَلَكَ طَرِيقًا يَلْتَمِسُ فِيهِ عِلْمًا سَهَّلَ اللَّهُ لَهُ بِهِ طَرِيقًا إِلَى الْجَنَّةِ",
    englishTranslation: "Whoever travels a path in search of knowledge, Allah will make easy for him a path to Paradise.",
    reference: "Sahih Muslim 2699",
    published: true,
  },
  {
    id: "seed-demo-inspiration-9",
    kind: "QURAN",
    arabicText: "قُلْ يَا عِبَادِيَ الَّذِينَ أَسْرَفُوا عَلَىٰ أَنفُسِهِمْ لَا تَقْنَطُوا مِن رَّحْمَةِ اللَّهِ",
    englishTranslation: "Say, 'O My servants who have transgressed against themselves [by sinning], do not despair of the mercy of Allah.'",
    reference: "Surah Az-Zumar 39:53",
    published: true,
  },
  {
    id: "seed-demo-inspiration-10",
    kind: "HADITH",
