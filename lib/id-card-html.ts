...
<body>
  ...
  >
    ...
    <!-- Header Section -->
    <div class="flex items-start justify-between px-10 pt-8 relative z-10">
      ...
      <div class="flex-1 flex flex-col items-center mt-0 ml-28">
        <h1 class="text-[44px] font-serif font-bold text-[#0f3d2e] tracking-wider uppercase mb-1">
          DARSE QURAN ACADEMY
        </h1>
        
        <div class="flex items-center gap-4 mb-4">
           <div class="h-[2px] w-12 bg-[#d4af37]"></div>
           <h2 class="text-[34px] font-bold text-[#0f3d2e]" style="font-family: 'Amiri', 'Traditional Arabic', serif;">خَيْرُكُمْ مَنْ تَعَلَّمَ الْقُرْآنَ وَعَلَّمَهُ</h2>
           <div class="h-[2px] w-12 bg-[#d4af37]"></div>
        </div>

        <div class="bg-[#0f3d2e] text-white px-8 py-2 rounded-lg flex items-center gap-4 mt-0 shadow-md">
    ...
    <!-- Main Content Grid -->
    <div class="flex-1 flex gap-10 px-10 mt-1 relative z-10 mb-8">
      
      <!-- Photo Column -->
      <div class="w-[260px] flex flex-col items-center z-10 ml-2 mt-3">
        <div class="w-[240px] h-[300px] border-[4px] border-[#0f3d2e] rounded-t-xl bg-white overflow-hidden relative shadow-md">
          ${profileContent}
        </div>
        <div class="w-[240px] bg-[#0f3d2e] text-white text-center py-2 rounded-b-xl border-[4px] border-t-0 border-[#0f3d2e] font-bold text-2xl tracking-wider shadow-md">
          STUDENT CARD
        </div>
      ...
      <!-- Details Column -->
      <div class="flex-1 flex flex-col justify-start pl-4 pt-1">
    ...
    <!-- Footer -->
    <div class="h-14 bg-[#0f3d2e] w-full mt-auto relative z-20 flex items-center px-12 justify-start border-t-[4px] border-[#d4af37] gap-3 rounded-b-[28px]">
      ...
      <div class="w-[1.5px] h-5 bg-white/50"></div>
